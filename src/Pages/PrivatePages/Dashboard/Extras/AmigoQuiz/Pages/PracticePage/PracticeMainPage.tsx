...
import { getAmigoQuizUrl, getPracticeQuizUrl } from "../../../../../../../Urls";
...
export const PracticeMainPage = ({ classOptions, isLoadingClassOptions }: MainProp) => {
  ...
  return (
    <Container>
      ...
      <FilterContainer>
        ...
        <ButtonElement
          label="Schedule Practice Quiz"
          width={300}
          onClick={() => navigate("#practice/schedule_practice_quiz")}
        />
      </FilterContainer>

      <DetailsContainer>
        <UpcomingSection>
          <h4>Upcoming Practice Quiz</h4>
          <h6>Upcoming Scheduled Practice Quiz Dates</h6>
          <CardContainer>
        ...
        <UpcomingSection>
          <h4>Past Practice Quiz</h4>
          <h6>Past Scheduled Practice Quiz Dates</h6>
